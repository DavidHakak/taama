              ...
              <div className="space-y-4">
                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-4">
                  ...
                  <div>
                    ...
                    <label className={`flex items-center gap-2.5 px-4 py-3 bg-black border border-zinc-900 rounded-xl text-white text-sm select-none ${
                      !hasStartersSelected ? 'opacity-50 cursor-not-allowed' : 'cursor-pointer'
                    }`}>
                      <input
                        type="checkbox"
