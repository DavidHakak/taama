      ...
      <div className="bg-zinc-950 border border-zinc-900 rounded-2xl p-6 sm:p-8 shadow-xl space-y-8 text-zinc-300 text-xs sm:text-sm leading-relaxed">
        ...
        <div className="space-y-3">
          ...
          <p>
            ...
            התשלום מתבצע במזומן במועד האיסוף; האתר אינו אוסף ואינו מעבד פרטי אמצעי תשלום.
          </p>
        </div>
        ...
        <div className="space-y-3">
          ...
          <p>
            קייטרינג טעמא מתחייב שלא למכור, להשכיר, או להעביר את פרטיכם האישיים לצדדים שלישיים כלשהם למטרות שיווקיות. העברת מידע תתבצע רק כאשר הדבר נדרש לצורך השלמת ההזמנה, לספקי תשתית ואחסון הפועלים עבורנו, או במידה ונידרש לכך על פי חוק או צו שיפוטי.
          </p>
        </div>
      </div>
    </div>
